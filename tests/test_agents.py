...
class TestAntigravityAdapter:
    ...
    def test_mcp_config_uses_loopback_for_wildcard_host(self, tmp_workspace):
        ...
        assert "list_formula_functions" in server["enabledTools"]
        assert "recalculate_value" in server["enabledTools"]
        assert "recalculate_all_values" in server["enabledTools"]
