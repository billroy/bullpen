...
def test_worker_card_menu_commands_render_icons_before_labels():
    ...
    assert "class=\"worker-menu-item\" @click=\"menuClearValueHistory\"><i class=\"menu-item-icon\" data-lucide=\"eraser\"" in text
    ...
    assert "class=\"worker-menu-item\" @click=\"menuScoped('pause', 'connected-group')\"><i class=\"menu-item-icon\" data-lucide=\"pause\"" in text
    assert "class=\"worker-menu-item worker-menu-danger\" @click=\"menuScoped('delete', 'connected-group')\"><i class=\"menu-item-icon\" data-lucide=\"trash-2\"" in text
